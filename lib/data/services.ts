...
export const services: Service[] = [
  ...
  },
  {
    ...
    short: "Conversion-rate optimization and landing pages that lift results without more spend.",
    hero: "The fastest way to lower cost per lead is often a better page. We build conversion-focused landing pages and run structured CRO to lift results without spending more.",
