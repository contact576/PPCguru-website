...
export const services: Service[] = [
  ...
  },
  {
    ...
    short: "We design and build fast, high-converting websites and landing pages from scratch.",
    hero: "Your website is your hardest-working salesperson. We design and build fast, mobile-first websites and landing pages — engineered from the ground up to turn clicks into booked leads.",
    description:
  ...
  {
    slug: "linkedin-ads",
    caseStudySlugs: ["immigration-consultant-brampton"],
    proofStats: [
      { value: "B2B", label: "decision-makers by title, company & seniority" },
      { value: "−20–35%", label: "cost per qualified lead after testing" },
      { value: "ABM", label: "account-based targeting for key accounts" },
    ],
    name: "LinkedIn Ads",
    short: "Precision B2B lead-gen targeting decision-makers by role, company and industry.",
    hero: "Reach the exact decision-makers who buy from you — by title, company, seniority and industry — with LinkedIn lead-gen built for pipeline, not vanity.",
    description: "LinkedIn Ads management for B2B and professional services — sponsored content, lead-gen forms and ABM targeting decision-makers that turn into pipeline.",
    icon: Briefcase,
    featured: false,
    outcomes: ["Decision-maker targeting", "Lower cost per qualified lead", "Lead-gen forms wired to CRM", "Account-based campaigns"],
    symptoms: ["Your buyers are senior but your ads reach everyone", "Lead-gen forms aren't connected to your CRM", "Cost per lead looks fine but quality is poor", "No account-based strategy for key targets"],
    whoFor: ["B2B and professional-services businesses", "High-value, considered purchases", "Teams with a clear ICP and offer", "Companies that need pipeline, not just leads"],
    included: ["ICP & audience build by role/company", "Sponsored content & document ads", "Native lead-gen forms to CRM", "ABM lists for target accounts", "Conversion tracking & Insight Tag", "Creative testing & reporting"],
    deliverables: [
      { title: "Audience & ICP build", body: "Targeting by job title, function, seniority, company size and industry — plus matched-account lists." },
      { title: "Creative & offers", body: "Sponsored content, document/lead-magnet ads and message testing built for B2B buyers." },
      { title: "Lead-gen integration", body: "Native LinkedIn lead forms wired into your CRM with instant routing." },
      { title: "ABM campaigns", body: "Account-based targeting and sequencing for your highest-value target accounts." },
    ],
    platforms: [
      { name: "Sponsored content", body: "Feed campaigns to your ICP with strong B2B offers and proof." },
      { name: "Lead-gen forms", body: "Native forms with high completion rates, routed to your CRM." },
      { name: "ABM", body: "Matched-account targeting for named, high-value accounts." },
      { name: "Retargeting", body: "Re-engage site visitors and engaged audiences across the funnel." },
    ],
    process: [
      { step: "01", title: "Define ICP", body: "We lock targeting, offer and the accounts that matter most." },
      { step: "02", title: "Build", body: "Campaigns, creative, lead forms and tracking go live." },
      { step: "03", title: "Test", body: "Audiences, offers and creative tested for qualified-lead cost." },
      { step: "04", title: "Scale", body: "We scale what produces pipeline and feed CRM outcomes back in." },
    ],
    metrics: ["Cost per qualified lead", "Lead-to-opportunity rate", "Pipeline influenced", "Form completion rate", "Cost per account reached", "Spend by ICP segment"],
    pricingFactors: ["Monthly ad budget (LinkedIn CPCs are higher)", "Number of audiences & accounts", "Creative volume produced", "CRM integration complexity"],
    faqs: [
      { q: "Isn't LinkedIn expensive?", a: "Clicks cost more than Google or Meta, so it only makes sense for higher-value, considered B2B purchases. We focus spend on tightly-defined decision-makers so the cost per qualified lead — not the CPC — is what matters." },
      { q: "Can you do account-based marketing?", a: "Yes — we build matched-account lists and sequence content to named target accounts, then tie results back to your CRM." },
    ],
  },
  {
    slug: "tiktok-ads",
    caseStudySlugs: ["real-estate-team-gta"],
    proofStats: [
      { value: "Hook-first", label: "native short-form creative that earns attention" },
      { value: "Weekly", label: "creative testing to beat fast fatigue" },
      { value: "Lower CPMs", label: "reach younger, high-intent audiences" },
    ],
    name: "TikTok Ads",
    short: "Native, hook-first short-form video campaigns that turn attention into leads.",
    hero: "TikTok rewards native creative, not polished ads. We produce hook-first short-form video and test relentlessly to turn attention into leads and sales.",
    description: "TikTok Ads management — native short-form video creative, Spark Ads, lead-gen and pixel/Events API tracking that turn attention into measurable results.",
    icon: Video,
    featured: false,
    outcomes: ["Native short-form creative", "Lower cost per result", "Always-on creative testing", "Trackable lead & sale events"],
    symptoms: ["Your ads look like ads — and get skipped", "Creative fatigues before you can react", "No tracking of TikTok-driven leads/sales", "You're missing a younger, high-intent audience"],
    whoFor: ["Brands that can produce (or let us produce) video", "Consumer and local services with visual appeal", "Advertisers ready to test creative weekly", "Businesses wanting reach beyond search & Meta"],
    included: ["Hook-first creative production", "Spark Ads from organic content", "Lead-gen & conversion campaigns", "Pixel / Events API setup", "Weekly creative testing", "Trend & competitor monitoring"],
    deliverables: [
      { title: "Creative production", body: "Native, hook-first short-form video built specifically for the TikTok feed." },
      { title: "Spark Ads", body: "Amplify your best organic posts as ads for authentic reach." },
      { title: "Campaign build", body: "Lead-gen and conversion campaigns with proper audience structure." },
      { title: "Tracking", body: "Pixel and Events API so TikTok optimizes on real conversions." },
    ],
    platforms: [
      { name: "In-feed video", body: "Native short-form video ads built around strong hooks." },
      { name: "Spark Ads", body: "Boost authentic organic content as high-performing ads." },
      { name: "Lead-gen", body: "Instant forms and conversion campaigns for measurable leads." },
      { name: "Retargeting", body: "Re-engage viewers and visitors who didn't convert." },
    ],
    process: [
      { step: "01", title: "Research", body: "We study your audience, trends and what's working in your niche." },
      { step: "02", title: "Produce", body: "A testing set of native, hook-first video creative." },
      { step: "03", title: "Test", body: "Rapid creative testing to find winners fast." },
      { step: "04", title: "Scale", body: "We scale winners and refresh creative to beat fatigue." },
    ],
    metrics: ["Cost per result", "Hook rate / hold rate", "Creative win rate", "Cost per lead", "Frequency & fatigue", "Spend by creative angle"],
    pricingFactors: ["Monthly ad budget", "Volume of video creative produced", "Whether we produce or you supply footage", "Tracking & CRM integration"],
    faqs: [
      { q: "We don't have video content — can you help?", a: "Yes. Our AI-augmented creative studio produces native, hook-first short-form video, and we can turn your raw clips or organic posts into Spark Ads." },
      { q: "Is TikTok only for younger audiences?", a: "Its audience has broadened a lot, but it skews younger and visual. We'll tell you honestly whether it fits your offer before you spend." },
    ],
  },
  {
    slug: "microsoft-ads",
    caseStudySlugs: ["dental-practice-etobicoke"],
    proofStats: [
      { value: "Lower CPCs", label: "often cheaper clicks than Google" },
      { value: "Import", label: "mirror winning Google campaigns fast" },
      { value: "Older, $$", label: "higher-income desktop search audience" },
    ],
    name: "Microsoft (Bing) Ads",
    short: "Capture the high-intent, often-cheaper search demand competitors ignore.",
    hero: "Bing's audience skews older and higher-income, and clicks are often cheaper. We mirror your winning Google strategy onto Microsoft Ads to capture demand competitors ignore.",
    description: "Microsoft (Bing) Ads management — search campaigns, Google import, and conversion tracking that capture high-intent, often-cheaper search demand.",
    icon: Search,
    featured: false,
    outcomes: ["Often lower cost per click", "Incremental high-intent demand", "Fast Google-import setup", "Conversion tracking you trust"],
    symptoms: ["You only run Google and ignore Bing entirely", "Your audience skews older / higher-income", "Google CPCs keep climbing", "You want incremental volume without more competition"],
    whoFor: ["Businesses already winning on Google Ads", "Audiences that skew older or professional", "Advertisers wanting cheaper incremental clicks", "Anyone maxing out Google impression share"],
    included: ["Microsoft Ads account setup", "Google import & adaptation", "Search & negative-keyword build", "Conversion tracking (UET)", "Bid strategy & optimization", "Reporting alongside Google"],
    deliverables: [
      { title: "Account setup & import", body: "We import and adapt your winning Google campaigns to Microsoft's auction." },
      { title: "Search build", body: "Tightly themed campaigns with negative-keyword hygiene for the Bing network." },
      { title: "UET tracking", body: "Microsoft conversion tracking so we optimize to real leads." },
      { title: "Optimization", body: "Bidding, search-term and creative tuning specific to Microsoft." },
    ],
    platforms: [
      { name: "Search campaigns", body: "High-intent keyword campaigns across Bing, Yahoo and partners." },
      { name: "Google import", body: "Mirror and adapt proven Google campaigns quickly." },
      { name: "Audience targeting", body: "LinkedIn profile targeting unique to Microsoft Ads." },
      { name: "Shopping", body: "Product campaigns for ecommerce where it fits." },
    ],
    process: [
      { step: "01", title: "Import", body: "We bring over and adapt your best Google campaigns." },
      { step: "02", title: "Tune", body: "Bids, negatives and creative tuned to Microsoft's auction." },
      { step: "03", title: "Track", body: "UET conversion tracking validated end to end." },
      { step: "04", title: "Optimize", body: "Ongoing optimization and reporting beside your Google account." },
    ],
    metrics: ["Cost per lead", "Cost per click vs Google", "Conversion rate", "Impression share", "Search-term quality", "Incremental conversions"],
    pricingFactors: ["Monthly ad budget", "Whether Google campaigns exist to import", "Number of campaigns & markets", "Tracking setup"],
    faqs: [
      { q: "Is Bing really worth it?", a: "For many service and B2B businesses, yes — the audience skews older and higher-income, clicks are often cheaper, and it's incremental volume on top of Google. We'll confirm the opportunity from your data first." },
      { q: "Can you reuse our Google campaigns?", a: "Yes — we import and then adapt them to Microsoft's auction rather than copying blindly, so they actually perform." },
    ],
  },
  {
    slug: "pinterest-ads",
    caseStudySlugs: [],
    proofStats: [
      { value: "High-intent", label: "users actively planning purchases" },
      { value: "Visual", label: "discovery that drives consideration" },
      { value: "Long life", label: "pins keep working over time" },
    ],
    name: "Pinterest Ads",
    short: "Reach high-intent planners discovering products and services to buy.",
    hero: "Pinterest users are planners — actively looking for things to buy, build and book. We turn that high-intent discovery into measurable leads and sales.",
    description: "Pinterest Ads management — visual discovery campaigns, shopping and lead-gen with conversion tracking for home, wedding, beauty, retail and considered purchases.",
    icon: ImageIcon,
    featured: false,
    outcomes: ["High-intent discovery reach", "Long-lasting creative", "Trackable leads & sales", "Strong fit for visual niches"],
    symptoms: ["Your visual product/service isn't being discovered", "You rely only on Meta for social demand", "Creative dies quickly on other platforms", "You sell considered, plannable purchases"],
    whoFor: ["Home, reno, wedding, beauty, food & retail", "Visually-driven products and services", "Considered purchases people plan for", "Brands with strong imagery (or willing to produce it)"],
    included: ["Visual creative production", "Idea & standard pin campaigns", "Shopping / catalog setup (if ecommerce)", "Conversion tag & tracking", "Audience & keyword targeting", "Creative testing & reporting"],
    deliverables: [
      { title: "Creative production", body: "Scroll-stopping pins and idea pins built for Pinterest discovery." },
      { title: "Campaign build", body: "Awareness, consideration and conversion campaigns with keyword + interest targeting." },
      { title: "Shopping setup", body: "Catalog and product pins for ecommerce where relevant." },
      { title: "Tracking", body: "Conversion tag so we optimize to real leads and sales." },
    ],
    platforms: [
      { name: "Standard & idea pins", body: "Visual discovery ads matched to what users are planning." },
      { name: "Shopping", body: "Catalog-driven product pins for ecommerce." },
      { name: "Keyword + interest", body: "Reach users by what they're actively searching and saving." },
      { name: "Retargeting", body: "Re-engage visitors and engaged pinners." },
    ],
    process: [
      { step: "01", title: "Plan", body: "We map your audience, keywords and visual angles." },
      { step: "02", title: "Produce", body: "A set of pins built for discovery and saves." },
      { step: "03", title: "Test", body: "Creative and targeting tested for cost per result." },
      { step: "04", title: "Scale", body: "We scale winners — and pins keep working over time." },
    ],
    metrics: ["Cost per result", "Cost per lead / sale", "Save & click-through rate", "Conversion rate", "Creative win rate", "Spend by angle"],
    pricingFactors: ["Monthly ad budget", "Volume of pin creative", "Ecommerce catalog complexity", "Tracking & CRM setup"],
    faqs: [
      { q: "Is Pinterest right for my business?", a: "It's strongest for visual, plannable purchases — home services and reno, weddings, beauty, food, decor and retail. If that's you, it can be a high-intent, lower-competition channel." },
      { q: "Do pins really last longer?", a: "Yes — unlike feed ads that disappear, pins continue to surface and drive traffic over weeks and months, which improves the long-run economics." },
    ],
  },
  {
    slug: "youtube-ads",
    caseStudySlugs: ["hvac-mississauga-lead-gen"],
    proofStats: [
      { value: "Demand-gen", label: "build awareness that fuels search & leads" },
      { value: "Skippable", label: "pay for engaged views, not skips" },
      { value: "Retarget", label: "re-engage viewers across Google" },
    ],
    name: "YouTube Ads",
    short: "Hook-first video that builds demand and feeds your whole funnel.",
    hero: "YouTube is where demand is built. We produce hook-first video and run in-stream, Shorts and demand-gen campaigns that lift awareness and feed your search and lead campaigns.",
    description: "YouTube Ads management — in-stream, Shorts and demand-gen video campaigns with strong hooks and tracking that build demand and drive leads.",
    icon: Play,
    featured: false,
    outcomes: ["Demand generation at scale", "Hook-first video creative", "Pay for engaged views", "Retargeting across Google"],
    symptoms: ["All your spend chases existing demand", "No top-of-funnel to feed search & leads", "Video creative is too slow/expensive to test", "You're not retargeting video viewers"],
    whoFor: ["Businesses ready to build demand, not just capture it", "Brands that can supply or let us produce video", "Higher-consideration offers", "Advertisers wanting cheaper reach than search"],
    included: ["Hook-first video production", "In-stream, in-feed & Shorts campaigns", "Demand-gen campaign setup", "Audience & intent targeting", "View & conversion tracking", "Retargeting sequences"],
    deliverables: [
      { title: "Video creative", body: "Hook-first video built for the first 5 seconds, edited for YouTube and Shorts." },
      { title: "Campaign build", body: "In-stream, in-feed and demand-gen campaigns with the right audiences." },
      { title: "Targeting", body: "Intent, audience and remarketing segments tuned to your funnel." },
      { title: "Tracking", body: "View-through and conversion tracking tied to leads." },
    ],
    platforms: [
      { name: "In-stream", body: "Skippable video where you pay for engaged views." },
      { name: "Shorts", body: "Vertical short-form video for cheap, high-reach attention." },
      { name: "Demand-gen", body: "Goal-based campaigns across YouTube and Google feeds." },
      { name: "Retargeting", body: "Re-engage viewers and visitors across Google's network." },
    ],
    process: [
      { step: "01", title: "Script", body: "We craft hooks and angles for your audience and offer." },
      { step: "02", title: "Produce", body: "A testing set of hook-first video creative." },
      { step: "03", title: "Test", body: "Audiences and creative tested for cost per view/lead." },
      { step: "04", title: "Scale", body: "Scale winners and feed warm audiences to search & lead campaigns." },
    ],
    metrics: ["Cost per view / engaged view", "View rate & hold rate", "Cost per lead (assisted)", "Conversion rate", "Retargeting performance", "Brand-search lift"],
    pricingFactors: ["Monthly ad budget", "Volume of video creative", "Whether we produce or you supply footage", "Tracking & funnel complexity"],
    faqs: [
      { q: "Does YouTube actually drive leads?", a: "It's mainly a demand-builder — it lifts awareness and brand search and feeds your bottom-funnel campaigns. We track assisted conversions and retarget viewers so it's measurable, not a black hole." },
      { q: "We don't have video — can you produce it?", a: "Yes. Our AI-augmented studio produces hook-first video for YouTube and Shorts, or edits your existing footage." },
    ],
  },
  {
    slug: "ai-automation",
    caseStudySlugs: ["immigration-consultant-brampton", "hvac-mississauga-lead-gen"],
    proofStats: [
      { value: "<5 min", label: "automated speed-to-lead follow-up" },
      { value: "24/7", label: "workflows that never sleep" },
      { value: "1 system", label: "spend → leads → booked revenue" },
    ],
    name: "AI Automation",
    short: "Custom AI workflows and automations that capture, qualify and follow up leads.",
    hero: "We build the AI workflows and automations behind a modern marketing team — instant lead follow-up, smart qualification, reporting and the glue that connects your whole stack.",
    description: "AI automation and marketing operations — speed-to-lead, AI lead qualification, automated reporting and custom workflows that connect ads, CRM and your tools.",
    icon: Bot,
    featured: false,
    outcomes: ["Instant lead follow-up", "AI lead qualification", "Automated reporting", "Connected, time-saving workflows"],
    symptoms: ["Leads wait hours for a first response", "Your team wastes hours on manual, repetitive work", "Reporting is stitched together by hand", "Your tools don't talk to each other"],
    whoFor: ["Businesses generating more leads than they can work", "Teams drowning in manual tasks", "Owners wanting one connected system", "Anyone who wants spend-to-revenue clarity"],
    included: ["Speed-to-lead automation", "AI lead scoring & qualification", "Nurture & follow-up sequences", "Automated reporting dashboards", "Tool integrations (Zapier/Make/n8n)", "Custom AI assistants & workflows"],
    deliverables: [
      { title: "Speed-to-lead", body: "Instant SMS/email and call routing the moment a lead arrives, with AI-drafted first touch." },
      { title: "AI qualification", body: "AI scores and routes leads so your team focuses on the ones most likely to book." },
      { title: "Automated reporting", body: "Live dashboards pulling spend, leads and revenue into one place automatically." },
      { title: "Custom workflows", body: "We connect your ads, forms, CRM and tools with reliable automations." },
    ],
    platforms: [
      { name: "Lead automation", body: "Speed-to-lead, routing and nurture across SMS and email." },
      { name: "AI assistants", body: "Custom assistants for qualification, drafting and support." },
      { name: "Integrations", body: "Zapier, Make and n8n to connect your whole stack." },
      { name: "Reporting", body: "Automated, always-current dashboards." },
    ],
    process: [
      { step: "01", title: "Map", body: "We map your lead lifecycle and the manual work to remove." },
      { step: "02", title: "Build", body: "Automations, AI steps and integrations configured and tested." },
      { step: "03", title: "Connect", body: "Ads, forms, calls and CRM flow into one system." },
      { step: "04", title: "Improve", body: "We monitor, refine and add workflows over time." },
    ],
    metrics: ["Speed to first contact", "Lead-to-booked-job rate", "Hours saved / month", "Leads worked vs missed", "Nurture re-engagement", "Cost per booked job"],
    pricingFactors: ["Number & complexity of workflows", "Tools and CRM to integrate", "Volume of AI usage", "Reporting requirements"],
    faqs: [
      { q: "Is this just Zapier zaps?", a: "It's more than that — we combine automation platforms with AI steps (qualification, drafting, summarization) and proper tracking, all designed around your sales process and monitored over time." },
      { q: "Will AI talk to my customers without oversight?", a: "Only where you want it to, and always reviewed. Most clients use AI for instant first-touch and qualification, with humans owning the real conversations." },
    ],
  },
  {
    ...
    proofStats: [
      { value: "+20–40%", label: "typical lift in landing-page conversion" },
      { value: "<2.5s", label: "Core Web Vitals load target" },
      { value: "A/B", label: "continuous testing, not guesswork" },
    ],
    name: "Landing Pages & CRO",
    short: "Structured A/B testing and CRO that squeeze more leads from the traffic you already pay for.",
    hero: "Already getting clicks but not enough leads? We run structured CRO — research, hypotheses and continuous A/B tests — to lift conversion on your existing pages, no extra ad spend required.",
    description: "Landing page design and conversion-rate optimization (CRO) — message-matched, fast, mobile-first pages and structured A/B testing that lift conversion rate.",
    icon: MousePointerClick,
    featured: false,
    outcomes: ["Higher conversion rate", "Lower cost per lead", "Faster, mobile-first pages", "Structured A/B testing"],
    symptoms: ["Ads send traffic to a slow, generic page", "Visitors land and leave without converting", "You've never run a real A/B test", "You can't tell which page or form produces leads"],
    whoFor: ["Advertisers whose page is the bottleneck", "Businesses with traffic but weak conversion", "Brands launching a new offer or campaign", "Anyone wanting more from existing spend"],
    included: ["Conversion-first page strategy", "Custom, on-brand landing pages", "Fast, mobile-first build", "Form-friction reduction", "A/B & multivariate testing", "Heatmaps & analytics wiring"],
    deliverables: [
      { title: "Conversion strategy", body: "We map the offer, proof and single primary action before any design." },
      { title: "Landing-page build", body: "Fast, mobile-first, message-matched pages for each campaign and offer." },
      { title: "CRO testing", body: "Structured A/B tests on headlines, layout, CTAs and forms." },
      { title: "Tracking & insight", body: "Heatmaps, session recordings and event tracking to find friction." },
    ],
    platforms: [
      { name: "Landing pages", body: "Dedicated, message-matched pages per campaign and offer." },
      { name: "CRO testing", body: "A/B and multivariate testing driven by data." },
      { name: "Performance", body: "Core Web Vitals, speed and accessibility that protect conversions." },
      { name: "Analytics", body: "Heatmaps, recordings and event tracking wired to your stack." },
    ],
    process: [
      { step: "01", title: "Map", body: "Offer, proof and primary action mapped; tracking planned." },
      { step: "02", title: "Build", body: "Conversion-first, mobile-first page built and wired." },
      { step: "03", title: "Test", body: "Structured A/B tests against a clear baseline." },
      { step: "04", title: "Iterate", body: "We keep testing to compound conversion-rate gains." },
    ],
    metrics: ["Landing-page conversion rate", "Cost per lead (vs old page)", "Bounce / engagement rate", "Core Web Vitals", "Form & call completions", "A/B test win rate"],
    pricingFactors: ["Number of pages / templates", "Single page vs full funnel", "Copywriting & creative needs", "Testing & integration complexity"],
    faqs: [
      { q: "Do I need a whole new website?", a: "Usually not. We often start with dedicated landing pages for your campaigns and CRO on your highest-traffic pages — the fastest path to lower cost per lead." },
      { q: "How long until conversion rate improves?", a: "Quick wins (speed, clarity, form friction) can land in the first few weeks; compounding gains come from ongoing structured testing over months." },
    ],
  },
];
