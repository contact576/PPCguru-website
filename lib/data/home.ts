...
export const homeFaqs = [
  ...
  { q: "Which industries do you specialize in?", a: "Healthcare and physiotherapy, home services (HVAC, plumbing, electrical), construction and renovation, immigration, real estate, and adjacent local service verticals." },
  {
    ...
    a: "We're based in the Greater Toronto Area (Toronto, ON) and serve clients across Canada and the USA, with deep local expertise in the GTA. Businesses operating specifically within the city can explore our Google Ads management in Toronto.",
    link: { href: "/toronto/google-ads", text: "Google Ads management in Toronto" },
  },
