...
export type LocationServiceContent = {
  ...
  whyLocal: string;
  /** Optional single contextual link rendered inside whyLocal. */
  whyLocalLink?: { href: string; text: string };
