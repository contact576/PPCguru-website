...
We go deeper in [landing page mistakes that kill conversions](/blog/landing-page-mistakes-killing-conversions).
...
1. Scan the search terms report; add negatives.
2. Pause keywords with high spend and zero conversions.
3. Check that calls and forms are still tracking.
4. Note your cost per lead trend - is it dropping?
