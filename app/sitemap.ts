...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    "/blog", "/contact", "/tools", "/tools/google-ads-calculator",
    "/tools/meta-ads-calculator", "/tools/instant-audit", "/tools/ad-copy-generator",
    "/privacy", "/terms",
  ].map((path) => ({
    url: `${base}${path}`,
    lastModified: now,
  ...
  return [...staticRoutes, ...serviceRoutes, ...industryRoutes, ...locationRoutes, ...caseRoutes, ...blogRoutes];
}
