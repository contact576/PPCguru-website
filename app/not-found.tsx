  ...
  return (
    <section className="relative flex min-h-[80vh] items-center justify-center overflow-hidden px-6 text-center">
      ...
      <div className="relative">
        ...
        <p className="mx-auto mt-3 max-w-md text-[--color-ink-dim]">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-[--color-ink-faint]">
          <Link href="/services" className="hover:text-[--color-ink]">Services</Link>
          <Link href="/industries" className="hover:text-[--color-ink]">Industries</Link>
          <Link href="/results" className="hover:text-[--color-ink]">Results</Link>
