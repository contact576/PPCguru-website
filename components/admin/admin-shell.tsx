...
import { FileText, Inbox, Target, Users, UserCheck, Settings, Search, ExternalLink, LogOut, Archive } from "lucide-react";
...
const TABS = [
  ...
  { href: "/admin/landing-leads", label: "Landing leads", icon: Target },
