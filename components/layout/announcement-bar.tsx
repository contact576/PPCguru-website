...
export function AnnouncementBar() {
  return (
    <div style={{ background: "#ceff3a", color: "#14170e", fontSize: 12.5, display: "flex", alignItems: "center", justifyContent: "center", gap: 14, padding: "9px 20px", flexWrap: "wrap", fontWeight: 600 }}>
      ...
      <Link href="/free-audit" className="mono" style={{ fontWeight: 700, display: "inline-flex", alignItems: "center", gap: 5, letterSpacing: ".06em", textTransform: "uppercase", textDecoration: "underline", textUnderlineOffset: 3 }}>Get my audit →</Link>
    </div>
  );
}
