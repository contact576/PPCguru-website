  ...
  return (
    <div style={{ background: "#ceff3a", color: "#14170e", fontSize: 12.5, display: "flex", alignItems: "center", justifyContent: "center", gap: 14, padding: "9px 20px", flexWrap: "wrap", fontWeight: 600 }}>
      <span className="mono" style={{ display: "inline-flex", alignItems: "center", gap: 8, letterSpacing: ".06em", textTransform: "uppercase" }}>
        ...
        30-day free trial — Google &amp; Meta Ads
      </span>
      <span style={{ opacity: 0.4 }} className="hidden sm:inline">/</span>
      <span className="mono hidden sm:inline" style={{ opacity: 0.75, letterSpacing: ".06em", textTransform: "uppercase" }}>No contract · No setup fee · You keep your accounts</span>
      <Link href="/free-audit" className="mono" style={{ fontWeight: 700, display: "inline-flex", alignItems: "center", gap: 5, letterSpacing: ".06em", textTransform: "uppercase", textDecoration: "underline", textUnderlineOffset: 3 }}>Start free →</Link>
    </div>
  );
}
